...
- Copy the JDBC .jar file to the java folder /java/bin.
- Update the process.bat file CLASSPATH (-cp) variable by appending a semi-colon and full path to the Oracle JDBC .jar file.
